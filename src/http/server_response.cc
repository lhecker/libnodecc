...
uv_buf_t str_status_code(uint16_t statusCode) {
	...
	case 302: ret.len = 2;  ret.base = const_cast<char*>("302 Moved Temporarily");               break;
	...
	case 404: ret.len = 2;  ret.base = const_cast<char*>("404 Not Found");                       break;
	...
	case 408: ret.len = 20; ret.base = const_cast<char*>("408 Request Time-out");                break;
